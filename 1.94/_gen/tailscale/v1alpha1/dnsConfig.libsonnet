{
  ...
  '#new':: d.fn(help='new returns an instance of DNSConfig', args=[d.arg(name='name', type=d.T.string)]),
  new(name): {
  ...
  '#spec':: d.obj(help='"Spec describes the desired DNS configuration.\\nMore info:\\nhttps://git.k8s.io/community/contributors/devel/sig-architecture/api-conventions.md#spec-and-status"'),
  spec: {
    '#nameserver':: d.obj(help='"Configuration for a nameserver that can resolve ts.net DNS names\\nassociated with in-cluster proxies for Tailscale egress Services and\\nTailscale Ingresses. The operator will always deploy this nameserver\\nwhen a DNSConfig is applied."'),
    nameserver: {
      '#image':: d.obj(help='"Nameserver image. Defaults to tailscale/k8s-nameserver:unstable."'),
      image: {
        '#withRepo':: d.fn(help='"Repo defaults to tailscale/k8s-nameserver."', args=[d.arg(name='repo', type=d.T.string)]),
        withRepo(repo): { spec+: { nameserver+: { image+: { repo: repo } } } },
        '#withTag':: d.fn(help='"Tag defaults to unstable."', args=[d.arg(name='tag', type=d.T.string)]),
        withTag(tag): { spec+: { nameserver+: { image+: { tag: tag } } } },
      },
      '#pod':: d.obj(help='"Pod configuration."'),
      pod: {
        '#tolerations':: d.obj(help='"If specified, applies tolerations to the pods deployed by the DNSConfig resource."'),
        tolerations: {
        ...
        '#withTolerations':: d.fn(help='"If specified, applies tolerations to the pods deployed by the DNSConfig resource."', args=[d.arg(name='tolerations', type=d.T.array)]),
        withTolerations(tolerations): { spec+: { nameserver+: { pod+: { tolerations: if std.isArray(v=tolerations) then tolerations else [tolerations] } } } },
        '#withTolerationsMixin':: d.fn(help='"If specified, applies tolerations to the pods deployed by the DNSConfig resource."\n\n**Note:** This function appends passed data to existing values', args=[d.arg(name='tolerations', type=d.T.array)]),
        withTolerationsMixin(tolerations): { spec+: { nameserver+: { pod+: { tolerations+: if std.isArray(v=tolerations) then tolerations else [tolerations] } } } },
      },
      '#service':: d.obj(help='"Service configuration."'),
      service: {
        '#withClusterIP':: d.fn(help='"ClusterIP sets the static IP of the service used by the nameserver."', args=[d.arg(name='clusterIP', type=d.T.string)]),
        withClusterIP(clusterIP): { spec+: { nameserver+: { service+: { clusterIP: clusterIP } } } },
      },
      '#withReplicas':: d.fn(help='"Replicas specifies how many Pods to create. Defaults to 1."', args=[d.arg(name='replicas', type=d.T.integer)]),
      withReplicas(replicas): { spec+: { nameserver+: { replicas: replicas } } },
    },
  },
  '#mixin': 'ignore',
  mixin: self,
